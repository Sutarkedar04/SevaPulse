              ...
              child: Padding(
                ...
                child: Column(
                  children: [
                    ...
                    Text(
                      doctorProfile['name'] ?? 'Doctor', // Now uses real name
                    ...
                    Text(
                      doctorProfile['specialization'] ?? 'Specialist', // Now uses real specialization
                      style: const TextStyle(
                        fontSize: 18,
                    ...
                    Text(
                      doctorProfile['hospital'] ?? 'City Hospital', // Now uses real hospital
                    ...
                    Row(
                      ...
                      children: [
                        _buildProfileStat('Patients', doctorProfile['patientsCount'].toString()),
                        const SizedBox(width: 20),
                        _buildProfileStat('Rating', '${doctorProfile['rating']} ⭐'),
                        const SizedBox(width: 20),
                        _buildProfileStat('Exp', doctorProfile['experience'] ?? '5 years'),
                      ],
                    ),
                  ],
                ),
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: 16),
                    _buildProfileDetail('Qualification', doctorProfile['qualification'] ?? 'MBBS'),
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: 8),
                    Text(
                      doctorProfile['bio'] ?? 'Experienced doctor dedicated to patient care.',
